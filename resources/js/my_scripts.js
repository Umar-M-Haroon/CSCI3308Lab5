...
function switchPlayers(player) {
	...
	document.getElementById("p_major").innerText = player.major;
	document.getElementById("g_played").innerText = player.games_played;
	...
	document.getElementById("avg_p_yards").innerText = Math.round(player.pass_yards / player.games_played);
	document.getElementById("avg_r_yards").innerText = Math.round(player.rushing_yards / player.games_played);
	document.getElementById("avg_rec_yards").innerText = Math.round(player.receiving_yards / player.games_played);
